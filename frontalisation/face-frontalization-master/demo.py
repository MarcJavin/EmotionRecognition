...
import sys
sys.path.append("/home/jordan/PycharmProjects/Emotion_Analysis/Facial_Expression_recog/src")
...
def demo():
    ...
    img = cv2.imread("/home/jordan/PycharmProjects/Emotion_Analysis/Facial_Expression_recog/data/test_photo.jpg", 1)
